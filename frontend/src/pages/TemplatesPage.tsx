...
import { TemplateEditor } from '../components/parametrage';
import templateService from '../services/templateService';
import { TemplateDocument, TemplateDocumentCreate, TemplateDocumentUpdate, TYPES_DOCUMENTS } from '../types/parametrage';
...
const TemplatesPage: React.FC = () => {
  ...
  const handleOpenDialog = async (template?: TemplateDocument) => {
    ...
    // Charger les variables pour le type de document
    ...
    <Box>
      ...
      <Paper sx={{ p: 3 }}>
        {loading ? (
          ...
          <Alert severity="info">
            Aucun template configuré. Initialisez les templates par défaut.
          </Alert>
        ) : (
